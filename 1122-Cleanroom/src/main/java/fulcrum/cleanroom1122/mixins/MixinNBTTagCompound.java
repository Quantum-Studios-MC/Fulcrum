...
public abstract class MixinNBTTagCompound implements IMCTagCompound {
	...
	@Shadow public abstract void setUniqueId(String key, UUID value);
	@Shadow public abstract UUID getUniqueId(String key);
	@Shadow public abstract boolean hasUniqueId(String key);
	...
	@Shadow public abstract byte getTagId(String key);
